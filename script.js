...
const API_KEY = "ce3ced1708938669006f7ecd2623d55c";// api key for openweathermap
...
const getCityCoordinates = () => {
    ...
    //get entered city coorddinates(latitude,longitude,name)
...
//get city name from coordinates using reverse geocoding Api
        ...
        error => {
            if (error.code === error.PERMISSION_DENIED) {
                alert("Geolocation request denied. Please reset location permission to granst access again.");
            }
        }
    );
}
